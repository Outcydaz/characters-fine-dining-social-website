				...
				function() {
					...
					$this.data('timeout',setTimeout( function() {
						$this.find('li').each(function(i) {
							var $this=$(this);					
							if ($.browser.msie && $.browser.version < 9) {	
								$this.cssAnimate({'top':'-20px','opacity':'1'},{duration:0});
								$this.data('lianim',setTimeout(function(){$this.css({'display':'block'})},10));
							} else {
								$this.cssAnimate({'top':'-20px','opacity':'1'},{duration:300});
								$this.data('lianim',setTimeout(function(){$this.css({'display':'block'})},400));							
							}
						});
					},300));
